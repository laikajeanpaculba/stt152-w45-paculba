...
Data frames most used data structure, named list of vectors of the same length with each vector as a column

similar to database table, google sheet, excel
